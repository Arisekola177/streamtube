  ...
  return (
    <div className="bg-[#191919] px-10 py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
      <div>
        ...
        <Link href={'/'} className="font-bold text-white text-2xl">Stream<span className="text-red-500">tube</span></Link>
      ...
      <div>
        ...
        <div className="text-gray-300 text-sm flex flex-col gap-2">
          <p>
            Phone: <span className="text-white font-medium">+234 8064272889</span>
          </p>
          <p>
            Email:{" "}
